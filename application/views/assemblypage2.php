    ...
    <form method="POST" action="/Assembly/assembleBots">   
        <table class="table table-condensed">
            ...
            <tr>
                <td>
                    <div>
                        <img src="../assets/images/parts/{head1}" name = "HeadImage" id="HeadImage" class="assembly_image" alt="{head1}"/> </br>
                ...
                <td class="container">
                    ...
                    <div class="btn-space">
                        <input type="button" class="btn btn-primary" value="Build" onclick="assemble()"></input>                  
                    ...
                    <div id="build">
                        <input type='submit' class="btn btn-primary" value='Build It'/>
                    </div>                
